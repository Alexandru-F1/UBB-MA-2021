      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              InputFields.inputField("Recipe name", "Recipe name", TextInputType.text, myRecipeNameModifyController, widget.recipe!.recipeName),
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            ...
                            try {
                            setState(() {
                              recipeModified = widget.modifyRecipe(widget.recipe!.id, myRecipeNameModifyController.text, myIngredientsModifyController.text, myCookingModifyController.text,
                                  myTimeModifyController.text, myDifficultyModifyController.text, double.parse(myCaloriesModifyController.text));
                            });
                            showDialog(
                                            ...
                                            if (snapshot.hasData) {
                                              return Column(
                                                children: [
                                                  ...
                                                  TextButton(
                                                    onPressed: () {
                                                      Provider.of<RecipeModelItems>(context, listen: false).modify(
                                                          widget.recipe!.id,
                                                          ...
                                                          double.parse(myCaloriesModifyController.text));
