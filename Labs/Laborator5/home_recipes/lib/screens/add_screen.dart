                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            ...
                            try {
                              setState(() {
                                recipeAdded = widget.addRecipe(myRecipeNameController.text, myIngredientsController.text, myCookingController.text, myTimeController.text, myDifficultyController.text,
